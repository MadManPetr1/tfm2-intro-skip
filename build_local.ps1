...
Copy-Item -LiteralPath (Join-Path $PSScriptRoot 'target/release/tfm2_intro_skip.dll') `
    -Destination (Join-Path $PSScriptRoot 'tfm2_intro_skip.dll') -Force
Write-Host 'Built Intro Skip with the Stable API.'
